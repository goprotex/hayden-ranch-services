...
const GALLERY = [
  { src: '/images/roof-hillcountry.jpg', alt: 'Hill Country home — drone aerial', cat: 'roofing' as const, span: true },
  { src: '/images/roof-ridge.jpg', alt: 'Metal roof ridge detail', cat: 'roofing' as const },
  { src: '/images/roof-closeup.jpg', alt: 'Standing seam metal panels', cat: 'roofing' as const },
  { src: '/images/roof-01.jpg', alt: 'Completed roof — drone overhead', cat: 'roofing' as const, span: true },
  { src: '/images/roof-gable-trim.jpg', alt: 'Cabin with new metal roof', cat: 'roofing' as const },
  ...
  { src: '/images/roof-03.jpg', alt: 'Shingle roof — drone overhead', cat: 'roofing' as const },
  { src: '/images/ranch-rainbow.jpg', alt: 'Rainbow over the ranch', cat: 'ranch' as const, span: true },
  { src: '/images/truck-sunset.jpg', alt: 'F-350 at sunset', cat: 'ranch' as const },
  { src: '/images/goat-sunset.jpg', alt: 'Boer goat at sunset', cat: 'ranch' as const },
  { src: '/images/windmill-stars.jpg', alt: 'Windmill under the stars', cat: 'ranch' as const },
  { src: '/images/windmill.jpg', alt: 'Ranch windmill at night', cat: 'ranch' as const },
  { src: '/images/hillcountry-landscape.jpg', alt: 'Texas Hill Country limestone bluffs', cat: 'ranch' as const, span: true },
  { src: '/images/land-clearing.jpg', alt: 'Cedar clearing with brush pile', cat: 'equipment' as const, span: true },
  { src: '/images/ranch-panorama.jpg', alt: 'Hill Country panorama', cat: 'ranch' as const, span: true },
