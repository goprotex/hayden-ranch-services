  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Michroma&family=Carattere&family=Crimson+Text:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet" />
      </head>
