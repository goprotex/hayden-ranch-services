    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative min-h-[100vh] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end max-w-7xl mx-auto w-full px-6 pb-16 md:pb-24">
          ...
          <Reveal>
            <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-display text-white mb-5 tracking-tightest leading-[0.92] uppercase">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <Reveal>
          ...
          <h2 className="text-3xl md:text-4xl font-display text-white tracking-tight mb-12 uppercase">
